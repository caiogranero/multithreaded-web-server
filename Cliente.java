...
public class Cliente extends Thread {
	// aqui no nosso caso será o 'localhost' que o ip da própria maquina aonde
	// você executará
	private String server;
	// neste caso utilizaremos a partir da porta 1024, sendo que menor são para
	// o Sistema Operacional
	private int porta;
	// aqui será a nossa string que será enviada para o servidor e ficará
	// repetindo diversas vezes
	...
	public static void main(String[] args) {
		try {
			...
			// o numero da porta
			int porta = 1024;
			// o numero máx de clientes que podem ser atendidos, mais que isso
			// começaremos a ter muitas exceções
	...
	public void run() {
		try {
			while (true) {
				// abrindo uma porta para fazermos a comunicação entre nosso
				// cliente e nosso servidor
				Socket s = new Socket(server, porta);
				// instaciando para enviarmos ao nosso servidor o que digitamos
				// no cliente
